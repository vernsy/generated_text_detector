...
mg_texts_llama = load_dataset(FILENAME_MG_DATASET_TEXTS_TRAIN_EVAL_LLAMA)
mg_labels_llama = [1]*len(mg_texts_llama)

texts = hw_texts + mg_texts_llama # gets later shuffled anyways
labels = hw_labels + mg_labels_llama
...
trainer.save_model(f'/data/verena/models/model_llama_{timestamp}')
